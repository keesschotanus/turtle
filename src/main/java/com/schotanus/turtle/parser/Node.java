...
interface Node {
  ...
  /**
   * Interprets the node.
   * @throws InterpretationException When an error occurs during interpretation
   *  of the node.
   */
  public void interpret() throws InterpretationException;
}
/* JavaCC - OriginalChecksum=60b3a6b5fdb834b04d81cac68cf20466 (do not edit this line) */
